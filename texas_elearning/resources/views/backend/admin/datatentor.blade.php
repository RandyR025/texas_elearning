...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- Edit Modal -->
            <div class="modal fade" id="edittentormodal">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header bg-blue">
                            <h4 class="modal-title">Update Data Tentor</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form action="" id="datatentoredit_form">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="editnama">Nama Tentor</label>
...
<script src="{{asset('js/Tentor.js')}}"></script>
@endsection
@endsection()
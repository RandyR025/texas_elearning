...
var jadwaltable = $("#datahasilquizcoverdetail").DataTable({
    ...
    responsive: true,
    ajax: {
        url: "/datahasilquizcover/data/" + pageID + "/" + pageID2,
        type: "GET",
        headers: {
            "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr("content"),
        },

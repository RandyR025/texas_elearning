            ...
            <div class="col-md-4">
                <div class="card card-primary">
                    ...
                    <div class="card-body" id="coba">
                        <form action="{{ route('dataquiztentor.tambah') }}" id="dataquiztentor_form" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" id="dataquiztentoredit_form" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
...
<script src="{{asset('js/QuizTentor.js')}}"></script>
@endsection
@endsection()